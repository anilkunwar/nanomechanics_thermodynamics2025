...
# ==========================================
# VISUALIZATION FUNCTIONS (ENHANCED WITH ROBUST TOOLTIPS)
# ==========================================
...
def render_graph_pyvis(nx_graph, concept_abstract_map, physics_enabled=True, 
                       ...
                       custom_labels=None, node_label_size=12, node_label_position="center", top_n_nodes=0, 
    ...
    """
    Enhanced PyVis renderer with ROBUST tooltip definition display and Glassmorphism UI.
    Ported from R50 OOM-Hardened Edition to fix R23 frontend display failures.
    """
    ...
    # --- Initialize label mapping for abbreviated labels ---
    label_map = {}
    n_counter = 1
    ...
    for i, node in enumerate(nx_graph.nodes()):
        ...
        # --- Abbreviation Logic with Inside-Node Positioning ---
        ...
        # =============================================================
        # ROBUST TOOLTIP CONSTRUCTION (Strictly Parseable Format)
        # =============================================================
...
<span style='color:{theme['tooltip_text']};opacity:0.7;'>Frequency:</span> {freq}"""
    ...
    # --- Edge Rendering ---
    color_map = {'cooccurrence': theme['edge_cooccurrence'], 'semantic': theme['edge_semantic'], 
    ...
    for u, v in nx_graph.edges():
        ...
        if edge_label_mode == "all" or (edge_label_mode == "threshold" and w >= weight_threshold):
            ...
            edge_kwargs['font'] = {'color': actual_edge_label_color, 'size': int(edge_label_size), 
                                   ...
                                   'strokeColor': theme['node_border'], 'align': edge_label_position, 'face': node_font_face}
    ...
    try:
        ...
        # ✅ FIX 1: Inject labelMap as hidden JSON div for JS to read
    ...
    # --- ADVANCED JS INJECTION (Glassmorphism UI & Tooltip Parsing) ---
            ...
            var checkExist = setInterval(function() {
                if (typeof network !== 'undefined' && network !== null && network.body && network.body.data) {
                    ...
                    function showEdgeInfoPanel(nodeId, connectedEdges) {
                        ...
                        html += '<button id="btn-short" onclick="window._agnpSetLabelMode(\\\'short\\\')" style="padding:4px 10px;border:none;border-radius:6px;font-size:10px;font-weight:700;cursor:pointer;background:#D32F2F;color:white;">Short</button>';
                        html += '<button id="btn-full" onclick="window._agnpSetLabelMode(\\\'full\\\')" style="padding:4px 10px;border:none;border-radius:6px;font-size:10px;font-weight:700;cursor:pointer;background:transparent;color:#64748b;">Full</button>';
                        html += '</div>';
    ...
    # --- Render Legend if abbreviated labels were used ---
    if use_abbreviated_labels and label_map:
        st.markdown("---")

# =============================================
# Advanced Phase-Field Model for Defect-Driven Sintering in Ag Nanoparticles
# =============================================
...
# =============================================
def create_initial_multi_np(n_particles, np_radius, defect_type, defect_pos, defect_size, eps0):
    eta = np.zeros((N, N))
...
init_eta = create_initial_multi_np(n_particles, np_radius, defect_type, defect_pos, defect_size, eps0)
...
if st.button("Run Phase-Field Sintering", type="primary"):
    with st.spinner("Running multi-particle sintering simulation..."):
        eta = init_eta.copy()
        history = []
...
if 'history' in st.session_state:
    ...
    metric = (initial_interface - final_interface) / initial_interface
    st.success(f"Sintering metric (relative interface reduction): {metric:.4f}")

...
def create_attention_interface():
    ...
    # Sidebar for custom base_dir
    base_dir = st.sidebar.text_input(
        "Simulation Directory",
        value=os.getenv('SIM_DIR', 'numerical_solutions'),
        help="Enter custom directory path or set SIM_DIR environment variable"
    )
   
    # Initialize interpolator in session state with base_dir

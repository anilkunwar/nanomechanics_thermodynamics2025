...
class TransformerSpatialInterpolator:
    ...
    # NEW METHOD: Prepare source data for advanced visualizations
...
class HeatMapVisualizer:
    ...
    # NEW METHOD 1: Radar Chart for Multi-Dimensional Source Comparison
    ...
    # NEW METHOD 2: Sunburst Chart for Hierarchical Source Organization
    ...
    # NEW METHOD 3: Chord Diagram for Attention Flow Visualization
...
def main():
    ...
    if st.session_state.interpolation_result:
        ...
        tab1, tab2 = st.tabs(["🎯 Attention Analysis", "🕸️ Source Relationship Visualizations"])
            ...
            if st.session_state.interpolation_result:
                ...
                if viz_type.startswith("Radar"):
                    ...
                    fig = st.session_state.heatmap_visualizer.create_chord_diagram(
                        ...
                        query_index=st.session_state.selected_ground_truth,
                        domain_size_nm=12.8  # Default domain size
                    )
                    st.plotly_chart(fig, use_container_width=True)
                ...
                - **Radar Chart**: Compare sources across 5 dimensions simultaneously. Query source highlighted in vivid pink.
                - **Sunburst Chart**: Navigate hierarchy: Outer ring = defect types → Middle = angle bins → Center = individual sources.
                - **Chord Diagram**: Thickness of chords shows attention strength between sources. Pink arcs = query source position.
                """)

...
class PredictionResultsManager:
    ...
    def prepare_prediction_data_for_saving(prediction_results: Dict[str, Any],
        ...
        Args:
            ...
            mode: 'multi' for multiple targets
    ...
    with tab7:
        ...
        if not has_multi_predictions:
            ...
            with col1:
                ...
                # PKL is for single, skip or adapt for multi if needed
                pass
           
            with col2:
                # PT Format - DIRECT PATTERN
                # PT is for single, skip
                pass
            ...
            # For multi, no individual for single

        ...
        try:
            ...
            return {
                ...
                'statistics': {
                    ...
                    'sigma_hydro': {  # FIXED: Changed from 'hydrostatic' to 'sigma_hydro'
                    ...
                    'sigma_mag': {  # FIXED: Changed from 'magnitude' to 'sigma_mag'
    ...
    if not st.session_state.solutions:
        ...
        with tab1:
            ...
            if st.session_state.interpolation_result:
                ...
                with col2:
                    hydro_stats = result['statistics']['sigma_hydro']  # FIXED: Changed from 'hydrostatic' to 'sigma_hydro'
                    st.metric("Hydrostatic Range", 
                             f"{hydro_stats['max_tension']:.3f}/{hydro_stats['max_compression']:.3f} GPa",
                             f"Mean: {hydro_stats['mean']:.3f} GPa")
                
                with col3:
                    mag_stats = result['statistics']['sigma_mag']  # FIXED: Changed from 'magnitude' to 'sigma_mag'
        ...
        with tab2:
            ...
            if st.session_state.interpolation_result:
                ...
                # Additional statistics - FIXED: Added proper key mapping
        ...
        with tab4:
            ...
            if st.session_state.interpolation_result:
                ...
                # Export statistics - FIXED: Added proper error handling for statistics access
